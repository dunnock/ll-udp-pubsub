import{h as d,j as p,k as u,al as _,c as m,am as h,m as n,an as t,ao as o,A as s,F as f,ap as v,aq as g,ar as b,s as l,as as x,at as y,q as k,au as N,av as w,_ as P}from"./nav-b1178112.js";import{N as S}from"./NoteDisplay-28982552.js";import{u as V}from"./index-4861a6e4.js";import"./_commonjsHelpers-725317a4.js";const j={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},q=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-gray-400/50 mb-8"},A=d({__name:"PresenterPrint",setup(F){p(u),_(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
